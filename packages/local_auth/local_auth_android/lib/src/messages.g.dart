...
class AuthOptions {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(biometricOnly, other.biometricOnly) && _deepEquals(sensitiveTransaction, other.sensitiveTransaction) && _deepEquals(sticky, other.sticky) && _deepEquals(checkBiometricInvalidationForKey, other.checkBiometricInvalidationForKey);
  }
...
class LocalAuthApi {
  ...
  Future<List<AuthClassification>> getHardwareBiometricCapabilities() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.local_auth_android.LocalAuthApi.getHardwareBiometricCapabilities$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
